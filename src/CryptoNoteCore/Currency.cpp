...
bool Currency::constructMinerTx(uint8_t blockMajorVersion, uint32_t height, size_t medianSize, uint64_t alreadyGeneratedCoins, size_t currentBlockSize,
  ...
  //Abre espa�o para uma tx se necess�rio
  if (maxOuts > 2) {
    maxOuts -= 1;
  }
  ...
  std::string addressStr = "invcJuhnst7BifZpkuqvuRVH7jxiCZ6fjXinroJxtenT7xzLbJx5pxWF7mWMq1mbnFdmL25uBzmBwBX1jdq4LzCs4KN4erqy89";
